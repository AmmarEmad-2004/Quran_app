...
class ServerFailer extends Failure {
  ServerFailer(String errorMessage) : super(errorMessage: errorMessage);
  ...
  factory ServerFailer.fromResponse(int statusCode, dynamic response) {
    if (statusCode == 400 || statusCode == 401 || statusCode == 403) {
      return ServerFailer(response["message"]);
    ...
    return ServerFailer('Unprocessable Entity, Please check the data you entered!');
